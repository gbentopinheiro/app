...
Ja existe tambem uma base documentada para os tres ambientes alvo (`LOCAL`, `DEV`, `PROD`) e para a promocao `LOCAL -> DEV -> PROD`, mas ainda falta automatizar pipelines, secrets e verificacoes por ambiente.

## Proximos Passos Recomendados

1. Fechar Backup / Restore com procedimento testado de ponta a ponta.
2. Consolidar hosting, observabilidade, secrets e variaveis de ambiente para um deploy repetivel em `LOCAL`, `DEV` e `PROD`.
