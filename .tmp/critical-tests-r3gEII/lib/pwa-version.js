const localFallbackBuildVersion = 'local-development'
const productionFallbackBuildVersion = 'unversioned'
const fallbackBuildVersion =
  process.env.NODE_ENV === 'production'
    ? productionFallbackBuildVersion
    : localFallbackBuildVersion
