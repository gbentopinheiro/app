...
export async function createClientDb(data) {
  ...
  const client = await prisma.client.create({
    data: {
      ...
      summaryLanguage: normalizeClientSummaryLanguage(data?.summaryLanguage),
    },
  })
...
export async function updateClientDb(id, data) {
  ...
  const client = await prisma.client.update({
    ...
    data: {
      ...
      summaryLanguage:
        data?.summaryLanguage !== undefined
          ? normalizeClientSummaryLanguage(data.summaryLanguage)
          : currentClient.summaryLanguage,
    },
  })
