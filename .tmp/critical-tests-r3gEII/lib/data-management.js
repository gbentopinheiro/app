  ...
  try {
    ...
    if (exportType === 'full' || exportType === 'all') {
      exportData = {
        ...
        planningWorkspaces: await getAllPlanningWorkspacesData(),
        planningWorkspaceAssignments: await getPlanningWorkspaceAssignmentsData(),
      ...
      exportData.planningWorkspaces = await getAllPlanningWorkspacesData()
      exportData.planningWorkspaceAssignments = await getPlanningWorkspaceAssignmentsData()
    }
