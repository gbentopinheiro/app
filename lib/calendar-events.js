...
export function getAllCalendarEvents(filters) {
  return calendarEventsService.getAll(filters)
}

export function createCalendarEvent(data) {
  return calendarEventsService.create(data)
}

export function updateCalendarEvent(id, data) {
  return calendarEventsService.update(id, data)
}
