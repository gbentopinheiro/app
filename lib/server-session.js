...
function normalizeSessionPermissionKeys(permissionKeys) {
...
function buildSessionAccessState(sessionLike) {
  ...
  const sessionPermissionKeys = normalizeSessionPermissionKeys(sessionLike?.permissionKeys)
  ...
  return {
    ...
    accessProfile,
    permissionKeys: Array.isArray(sessionLike?.permissionKeys)
...
export async function getServerSession() {
  ...
  const resolvedSession = runtimeUser
    ? {
        ...
        chefCategory: runtimeUser.person?.chefCategory || session.chefCategory || null,
  ...
  return buildSessionAccessState({
    ...
    role,
    chefCategory: identity.person?.chefCategory || resolvedSession.chefCategory || null,
    workIds:
